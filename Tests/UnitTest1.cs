...
public class UnitTest1
{
    ...
    {
        WoopEssentials.WoopEssentials.Config = new WoopConfig
        {
        ...
        WoopEssentials.WoopEssentials.LoadRestartTime(now);
        Assert.Equal(DateTime.Parse("5/15/2023 10:52:00 AM"), WoopEssentials.WoopEssentials.ShutDownTime);
        var timeTillRestart = WoopEssentials.WoopEssentials.ShutDownTime - now;
    ...
    public void TestTimeBetweenTodayAndNextDay()
    {
        ...
        WoopEssentials.WoopEssentials.LoadRestartTime(now);
        Assert.Equal(DateTime.Parse("5/14/2023 10:30:00 AM"), WoopEssentials.WoopEssentials.ShutDownTime);
        var timeTillRestart = WoopEssentials.WoopEssentials.ShutDownTime - now;
    ...
    public void TestLastTimeOfToday()
    {
        ...
        WoopEssentials.WoopEssentials.LoadRestartTime(now);
        Assert.Equal(DateTime.Parse("5/14/2023 10:40:00 AM"), WoopEssentials.WoopEssentials.ShutDownTime);
        var timeTillRestart = WoopEssentials.WoopEssentials.ShutDownTime - now;
    ...
    public void TestFirstTimeOfToday()
    {
        ...
        WoopEssentials.WoopEssentials.LoadRestartTime(now);
        Assert.Equal(DateTime.Parse("5/14/2023 10:10:00 AM"), WoopEssentials.WoopEssentials.ShutDownTime);
        var timeTillRestart = WoopEssentials.WoopEssentials.ShutDownTime - now;
        Assert.Equal(TimeSpan.Parse("00:04:58") , timeTillRestart);
    }
    ...
    public void TestOnlyOneTimeNext()
    {
        ...
        WoopEssentials.WoopEssentials.LoadRestartTime(now);
        Assert.Equal(DateTime.Parse("5/15/2023 07:43:00 AM"), WoopEssentials.WoopEssentials.ShutDownTime);
        var timeTillRestart = WoopEssentials.WoopEssentials.ShutDownTime - now;
    ...
    public void TestOnlyOneTimeToday()
    {
        ...
        WoopEssentials.WoopEssentials.LoadRestartTime(now);
        Assert.Equal(DateTime.Parse("5/14/2023 07:43:00 AM"), WoopEssentials.WoopEssentials.ShutDownTime);
        var timeTillRestart = WoopEssentials.WoopEssentials.ShutDownTime - now;
