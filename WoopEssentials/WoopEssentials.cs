...
public class WoopEssentials : ModSystem
{
    ...
    internal static readonly string WoopEssentialsModDataKey = "woopEssentials";
    ...
    public override void StartServerSide(ICoreServerAPI sapi)
    {
        ...
        {
            Sapi.Logger.Error(Lang.Get("woopessentials:woopconfig-error", e));
        ...
        Sapi.ChatCommands.Create("reloadwoopconfig")
    ...
    private void PlayerNowPlaying(IServerPlayer byPlayer)
    {
        ...
        {
            var data = byPlayer.WorldData.GetModdata(WoopEssentialsModDataKey);
            if (data != null)
            {
    ...
    private bool ReloadConfig()
    {
        ...
        {
            Sapi.Logger.Error("Error reloading WoopConfig: ", e.ToString());
            return false;
        }
